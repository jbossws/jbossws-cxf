...
* <<anchor-901,SAML Bearer Assertion Scenario>>
** <<anchor-902,Web service Provider>>
*** <<anchor-903,Web service provider WSDL>>
*** <<anchor-904,SSL configuration>>
*** <<anchor-905,Web service Interface>>
*** <<anchor-906,Web service Implementation>>
*** <<anchor-907,Crypto properties and keystore files>>
*** <<anchor-908,MANIFEST.MF>>
** <<anchor-909,Bearer Security Token Service>>
*** <<anchor-910,Security Domain>>
*** <<anchor-911,STS's WSDL>>
*** <<anchor-912,STS's implementation class>>
*** <<anchor-913,STSBearerCallbackHandler>>
*** <<anchor-914,Crypto properties and keystore files>>
*** <<anchor-915,MANIFEST.MF>>
** <<anchor-916,Web service requester>>
*** <<anchor-917,Web service requester Implementation>>
*** <<anchor-918,ClientCallbackHandler>>
*** <<anchor-919,Crypto properties and keystore files>>
...
Follow the directions in the, "Using the pure Java implementation supplied by JSSE" section in the
https://docs.jboss.org/author/index.html[SSL Setup Guide].
...
For this scenario the domain needs to contain user alice, password clarinet, and role friend. See the listings below for jbossws-users.properties and jbossws-roles.properties.  In addition the following XML must be added to the JBoss security subsystem in the server configuration file.
...
https://docs.jboss.org/author/index.html#WS-TrustandSTS-ClientCallbackHandler[https://docs.jboss.org/author/display/JBWS/WS-Trust+and+STS#WS-TrustandSTS-ClientCallbackHandler]
...
https://docs.jboss.org/author/index.html#WS-TrustandSTS-RequesterCryptopropertiesandkeystorefiles[https://docs.jboss.org/author/display/JBWS/WS-Trust+and+STS#WS-TrustandSTS-RequesterCryptopropertiesandkeystorefiles]
