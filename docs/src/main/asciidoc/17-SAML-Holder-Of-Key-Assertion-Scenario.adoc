...
* <<anchor-1001,SAML Holder-Of-Key Assertion Scenario>>
** <<anchor-1002,Web service Provider>>
*** <<anchor-1003,Web service provider WSDL>>
*** <<anchor-1004,SSL configuration>>
*** <<anchor-1005,Web service Interface>>
*** <<anchor-1006,Web service Implementation>>
*** <<anchor-1007,Crypto properties and keystore files>>
*** <<anchor-1008,MANIFEST.MF>>
** <<anchor-1009,Security Token Service>>
*** <<anchor-1010,Security Domain>>
*** <<anchor-1011,STS's WSDL>>
*** <<anchor-1012,STS's implementation class>>
*** <<anchor-1013,HolderOfKeyCallbackHandler>>
*** <<anchor-1014,Crypto properties and keystore files>>
*** <<anchor-1015,MANIFEST.MF>>
** <<anchor-1016,Web service requester>>
*** <<anchor-1017,Web service requester Implementation>>
*** <<anchor-1018,ClientCallbackHandler>>
*** <<anchor-1019,Crypto properties and keystore files>>
...
https://docs.jboss.org/author/index.html#WS-TrustandSTS-SSLconfiguration[https://docs.jboss.org/author/display/JBWS/WS-Trust+and+STS#WS-TrustandSTS-SSLconfiguration]
...
https://docs.jboss.org/author/index.html#WS-TrustandSTS-MANIFEST.MF[https://docs.jboss.org/author/display/JBWS/WS-Trust+and+STS#WS-TrustandSTS-MANIFEST.MF]
