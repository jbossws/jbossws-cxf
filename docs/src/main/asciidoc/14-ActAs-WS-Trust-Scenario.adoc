...
* <<anchor-701,ActAs WS-Trust Scenario>>
** <<anchor-702,Web service provider>>
*** <<anchor-703,Web service provider WSDL>>
*** <<anchor-704,Web Service Interface>>
*** <<anchor-705,Web Service Implementation>>
*** <<anchor-706,ActAsCallbackHandler>>
*** <<anchor-707,UsernameTokenCallbackHandler>>
*** <<anchor-708,Crypto properties and keystore files>>
*** <<anchor-709,MANIFEST.MF>>
** <<anchor-710,Security Token Service>>
*** <<anchor-711,STS Implementation class>>
*** <<anchor-712,STSCallbackHandler>>
** <<anchor-713,Web service requester>>
*** <<anchor-714,Web service requester Implementation>>
...
The ActAs scenario is an extension of the
[basic WS-Trust scenario].
...
https://docs.jboss.org/author/index.html#WS-TrustandSTS-WebservicerequesterImplementation[the Basic Scenario client].
