...
* <<anchor-801,OnBehalfOf WS-Trust Scenario>>
** <<anchor-802,Web service provider>>
*** <<anchor-803,Web service provider WSDL>>
*** <<anchor-804,Web Service Interface>>
*** <<anchor-805,Web Service Implementation>>
*** <<anchor-806,OnBehalfOfCallbackHandler>>
** <<anchor-807,Web service requester>>
*** <<anchor-808,Web service requester Implementation>>
...
Infor here http://coheigea.blogspot.com/2012/01/apache-cxf-251-sts-updates.html[Open Source Security: Apache CXF 2.5.1 STS updates ]
