...
JBoss Web Services allows communication over the JMS transport. The functionality comes from Apache CXF support for the
https://www.w3.org/TR/soapjms/[SOAP over Java Message Service 1.0]
specification, which is aimed at a set of standards for interoperable transport of SOAP messages over JMS.
...
The https://cxf.apache.org/docs/soap-over-jms-10-support.html[Apache CXF documentation]
