...
Apache CXF API usage (given that's included in the AS), losing the Jakarta
...
only for the created JAX-WS client but won't stay associated to the
...
JAX-WS client but won't stay associated to the current thread at the end
