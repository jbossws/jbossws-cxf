...
public class JBWS3945TestCase extends JBossWSTest
{
   ...
   private String targetEndpoint = "http://" + getServerHost() + ":8080/jaxws-samples-exception-jbws3945/SOAP12ExceptionEndpointService";
   

   public static Test suite()
   {
      return new JBossWSTestSetup(JBWS3945TestCase.class, "jaxws-samples-exception-jbws3945.war");
   }
