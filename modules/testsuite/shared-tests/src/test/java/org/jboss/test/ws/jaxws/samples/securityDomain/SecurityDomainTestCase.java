...
public class SecurityDomainTestCase extends JBossWSTest
{
   ...
   public final String TARGET_ENDPOINT_ADDRESS_3 = "http://" + getServerHost() + ":8080/jaxws-securityDomain3/authz";

   public static Test suite()
   {
      JBossWSTestSetup testSetup = new JBossWSTestSetup(SecurityDomainTestCase.class, "jaxws-samples-securityDomain.jar,jaxws-samples-securityDomain3.jar");
      Map<String, String> authenticationOptions = new HashMap<String, String>();
      authenticationOptions.put("usersProperties", getResourceFile("jaxws/samples/securityDomain/jbossws-users.properties").getAbsolutePath());
      authenticationOptions.put("rolesProperties", getResourceFile("jaxws/samples/securityDomain/jbossws-roles.properties").getAbsolutePath());
   ...
   private SecureEndpoint getAuthzPort3() throws Exception
   {
      URL wsdlURL = new URL(TARGET_ENDPOINT_ADDRESS_3 + "?wsdl");
   ...
   {
      SecureEndpoint port = getAuthzPort3();
      testOneWay(port);
   }
