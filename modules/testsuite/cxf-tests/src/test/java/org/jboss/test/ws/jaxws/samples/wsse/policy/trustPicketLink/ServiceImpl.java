...
(
   ...
   endpointInterface = "org.jboss.test.ws.jaxws.samples.wsse.policy.trustPicketLink.ServiceIface"
)
@EndpointProperties(value = {
      ...
      @EndpointProperty(key = "ws-security.callback-handler", value = "org.jboss.test.ws.jaxws.samples.wsse.policy.trustPicketLink.ServerCallbackHandler")      
})
