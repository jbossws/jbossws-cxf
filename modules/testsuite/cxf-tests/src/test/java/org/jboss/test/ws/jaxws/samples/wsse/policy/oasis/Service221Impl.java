...
@WebService
(
   portName = "SecurityService221Port",
...
@Stateless
@WebContext(urlPattern = "SecurityService221")
public class Service221Impl implements ServiceIface
{
   public String sayHello()
   {
      return "Hello - (WSS1.0) X.509 Certificates, Sign, Encrypt";
   }
}
