...
public final class PicketboxUsernameAuthorizationDigestEjbTestCase extends JBossWSTest
{
   @ArquillianResource
   private URL baseURL;
   ...
   public static JavaArchive createDeployment() {
      ...
      archive
            ...
            .addClass(org.jboss.test.ws.jaxws.samples.wsse.policy.jaas.PicketboxEJBDigestServiceImpl.class)
   ...
   {
      URL wsdlURL = new URL(baseURL + "/jaxws-samples-wsse-policy-username-jaas-ejb-digest/SecurityService/PicketboxEJBDigestServiceImpl?wsdl");
