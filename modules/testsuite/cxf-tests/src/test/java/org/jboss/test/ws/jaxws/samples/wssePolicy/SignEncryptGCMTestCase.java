...
{
   private final String serviceURL = "http://" + getServerHost() + ":8080/jaxws-samples-wssePolicy-sign-encrypt-gcm";
   
   public static Test suite()
   {
      return new JBossWSTestSetup(SignEncryptGCMTestCase.class, "jaxws-samples-wssePolicy-sign-encrypt-client.jar jaxws-samples-wssePolicy-sign-encrypt-gcm.war");
   }
