...
@WebService
(
   portName = "SecurityService224Port",
...
@Stateless
@WebContext(urlPattern = "SecurityService224")
public class Service224Impl implements ServiceIface
{
   public String sayHello()
   {
      return "Hello - (WSS1.1) Mutual Authentication with X.509 Certificates, Sign, Encrypt";
   }
}
