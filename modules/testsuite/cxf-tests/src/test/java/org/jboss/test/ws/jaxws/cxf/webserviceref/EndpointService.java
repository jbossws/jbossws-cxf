...
@WebServiceClient(name = "EndpointService", targetNamespace = "http://org.jboss.ws/wsref", wsdlLocation = "file://bogus-location/jaxws-cxf-webserviceref?wsdl")
    ...
    extends Service
{
    ...
    static {
        URL url = null;
        try {
            url = new URL("file://bogus-location/jaxws-cxf-webserviceref?wsdl");
