...
public final class PicketboxUsernameAuthorizationDigestTestCase extends JBossWSTest
{
   @ArquillianResource
   private URL baseURL;
   ...
   public static WebArchive createDeployment() {
      ...
      archive.setManifest(new StringAsset("Manifest-Version: 1.0\n"
            ...
            .addAsWebInfResource(new File(JBossWSTestHelper.getTestResourcesDir() + "/jaxws/samples/wsse/policy/jaas/digest/WEB-INF/jboss-web-picketbox.xml"), "jboss-web.xml")
