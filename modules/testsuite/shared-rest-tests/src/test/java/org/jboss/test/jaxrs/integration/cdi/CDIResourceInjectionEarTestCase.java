...
public class CDIResourceInjectionEarTestCase
{
   ...
   {
      EnterpriseArchive ear = ShrinkWrap.create(EnterpriseArchive.class, "jaxrs-integration-cdi-ear.ear");
      WebArchive archive = ShrinkWrap.create(WebArchive.class, "jaxrs-integration-cdi-internal.war");
      archive.addManifest().addClasses(CDIResource.class, CDIBean.class)
