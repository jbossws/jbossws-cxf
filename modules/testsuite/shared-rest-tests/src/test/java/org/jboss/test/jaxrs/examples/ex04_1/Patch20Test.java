...
public class Patch20Test extends JBossWSTest
{
   @ArquillianResource
   private URL baseURL;
   ...
   public static WebArchive createDeployments() {
      WebArchive archive = ShrinkWrap.create(WebArchive.class, "jaxrs20-examples-ex04_1.war");
         archive
               .addManifest()
   ...
   public void testCustomerResource() throws Exception
   {
      ...
      try {
         String xml = "<customer>"
          ...
          Assert.assertTrue(response.getHeaderString("Location").contains("jaxrs20-examples-ex04_1/services/customers/1"));
          response.close();
