...
@RunAsClient
public class ApplicationIntegrationTestCase extends JBossWSTest
{
   @ArquillianResource
   private URL baseURL;
   ...
   public static WebArchive createDeployments()
   {
      ...
      archive.addManifest().addClass(org.jboss.test.jaxrs.deployment.war.HelloWorldApplication.class)
