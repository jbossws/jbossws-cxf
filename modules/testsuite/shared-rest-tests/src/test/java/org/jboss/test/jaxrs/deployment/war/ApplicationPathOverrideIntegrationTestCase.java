...
@RunAsClient
public class ApplicationPathOverrideIntegrationTestCase extends JBossWSTest
{
   @ArquillianResource
   private URL baseURL;
   ...
   {
      WebArchive archive = ShrinkWrap.create(WebArchive.class, "jaxrs-deployment-war-app3.war");
   ...
   private static StringAsset getWebXml()
   {
      return new StringAsset(
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n"
                  ...
                  + "version=\"3.0\"><servlet-mapping><servlet-name>" + HelloWorldPathApplication.class.getName()
                  + "</servlet-name><url-pattern>/override/*</url-pattern></servlet-mapping></web-app>");
   }
